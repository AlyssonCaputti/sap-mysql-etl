...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("sku_custo_cd_giba", "SkuCustoCdGiba"),
        ("Vendedores ilha growth", "VendedoresIlhaGrowth"),
        ("itens", "Itens"),
        ("base-blacklist-delinte", "BaseBlacklistDelinte"),
...
def test_nome_fixo_preserva_o_nome_que_esta_no_banco():
    """CICATRIZ: `TabelaPreOPromocao` existe no banco com o nome corrompido.

    A transliteracao geraria `TabelaPrecoPromocao` — tabela NOVA, deixando a
    antiga orfa e o consumidor lendo dado congelado. Decisao de 18/08/2026:
    manter o nome como esta.
    """
    assert upload.nome_tabela("tabela-preço-promocao") == "TabelaPreOPromocao"


def test_nome_fixo_nao_depende_de_caixa_da_pasta():
